...
fileName = "../../multipleSD/nn8SDinttime3_inputtarget.csv"
...
history = reg.fit(x_train, y_train, batch_size=32, callbacks = [reduce_lr, earlyStop], epochs = 1000, validation_split = .2)
