function [hbseries,hbO2series,muaseries]=threewavelengthdpf(d1,d2,d3,bl1,bl2,bl3,lambdas,sdsep,DPF)
%Last Edited 072910 by EB

waterconc=0;
lipidconc=0;
[eHBO2,eHB,Muawater,mualipid]=getextinctioncoef_new(waterconc,lipidconc,lambdas);
