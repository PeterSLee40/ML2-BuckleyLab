function [eventtimes,events]=CNSvitals_4adenosine(subjectid,patdate,ext,savefigures,timeaxis,Markstime,timesyncmark_dcs,savematfile,rotatelabel,invivo,hrmin,bpmin,bpmax,hrmax,spo2min,rapmin,mapnans)


fdir=[ '../' subjectid '/' subjectid 'notes/' subjectid '_' patdate ext 'vitals/'];
hrlim=[60 200];
bplim=[20 110];
SpO2lim=[50 100];
raplim=[0 20];
...
if exist(fnametmp)
    ...
    if savefigures
        ...
        saveas(gcf,['../' subjectid '/' subjectid 'notes/savedfigs/' patdate '_' subjectid ext '_HR.eps'],'epsc2')
        saveas(gcf,['../' subjectid '/' subjectid 'notes/savedfigs/' patdate '_' subjectid ext '_HR.png'],'png')

    end
    if savematfile
        tt=['save vitals' subjectid '_' patdate ext ' events eventtimes sync hr time_hr invivo'];
        eval(tt);
    end
end
clear fnametmp
...
if exist(fnametmp)
    ...
    %Sync time of etco2 data with optical data
    ...
    if savefigures
        ...
        saveas(gcf,['../' subjectid '/' subjectid 'notes/savedfigs/' patdate '_' subjectid ext '_etco2.fig'],'fig')
        saveas(gcf,['../' subjectid '/' subjectid 'notes/savedfigs/' patdate '_' subjectid ext '_etco2.eps'],'epsc2')
        saveas(gcf,['../' subjectid '/' subjectid 'notes/savedfigs/' patdate '_' subjectid ext '_etco2.png'],'png')

    end
    if savematfile
        tt=['save vitals' subjectid '_' patdate ext ' etco2 time_etco2 -append'];
        eval(tt);
    end
...
if exist(fnametmp)
    ...
    if savefigures
        ...
        saveas(gcf,['../' subjectid '/' subjectid 'notes/savedfigs/' patdate '_' subjectid ext '_inco2.eps'],'epsc2')
        saveas(gcf,['../' subjectid '/' subjectid 'notes/savedfigs/' patdate '_' subjectid ext '_inco2.png'],'png')

    end
    if savematfile
        tt=['save vitals' subjectid '_' patdate ext ' inco2 time_inco2 -append'];
        eval(tt);
    end
...
if exist(fnametmp)
    ...
    if savefigures
        ...
        saveas(gcf,['../' subjectid '/' subjectid 'notes/savedfigs/' patdate '_' subjectid ext '_SpO2.eps'],'epsc2')
        saveas(gcf,['../' subjectid '/' subjectid 'notes/savedfigs/' patdate '_' subjectid ext '_SpO2.png'],'png')

    end
    if savematfile
        tt=['save vitals' subjectid '_' patdate ext ' spo2 time_spo2 -append'];
        eval(tt);
    end
end
clear fnametmp
...
if exist(fnametmp)
    ...
    if savefigures
        ...
        saveas(gcf,['../' subjectid '/' subjectid 'notes/savedfigs/' patdate '_' subjectid ext '_RAP.fig'],'fig')
        saveas(gcf,['../' subjectid '/' subjectid 'notes/savedfigs/' patdate '_' subjectid ext '_RAP.eps'],'epsc2')
        saveas(gcf,['../' subjectid '/' subjectid 'notes/savedfigs/' patdate '_' subjectid ext '_RAP.png'],'png')

    end
    if savematfile
        tt=['save vitals' subjectid '_' patdate ext ' rap time_rap -append'];
        eval(tt);
    end
end
clear fnametmp
...
if exist(fnametmp)
    ...
    if savefigures
        ...
        saveas(gcf,['../' subjectid '/' subjectid 'notes/savedfigs/' patdate '_' subjectid ext '_Resp.fig'],'fig')
        saveas(gcf,['../' subjectid '/' subjectid 'notes/savedfigs/' patdate '_' subjectid ext '_Resp.eps'],'epsc2')
        saveas(gcf,['../' subjectid '/' subjectid 'notes/savedfigs/' patdate '_' subjectid ext '_Resp.png'],'png')

    end
    if savematfile
        tt=['save vitals' subjectid '_' patdate ext ' resp time_resp -append'];
        eval(tt);
    end
end
clear fnametmp
...
if exist(fnametmp)
    ...
    if savefigures
        ...
        saveas(gcf,['../' subjectid '/' subjectid 'notes/savedfigs/' patdate '_' subjectid ext '_NBP.fig'],'fig')
        saveas(gcf,['../' subjectid '/' subjectid 'notes/savedfigs/' patdate '_' subjectid ext '_NBP.eps'],'epsc2')
        saveas(gcf,['../' subjectid '/' subjectid 'notes/savedfigs/' patdate '_' subjectid ext '_NBP.png'],'png')

    end
    if savematfile
        tt=['save vitals' subjectid '_' patdate ext ' nbpsys nbpdias nmap time_nbpsys time_nbpdias time_nmap -append'];
        eval(tt);
    end
end
clear fnametmp
...
if exist(fnametmp)
    ...
    if savefigures
        ...
        saveas(gcf,['../' subjectid '/' subjectid 'notes/savedfigs/' patdate '_' subjectid ext '_ABP.fig'],'fig')
        saveas(gcf,['../' subjectid '/' subjectid 'notes/savedfigs/' patdate '_' subjectid ext '_ABP.eps'],'epsc2')
        saveas(gcf,['../' subjectid '/' subjectid 'notes/savedfigs/' patdate '_' subjectid ext '_ABP.png'],'png')

    end
    if savematfile && invivo
        tt=['save vitals' subjectid '_' patdate ext ' bpsys bpdias time_bpsys time_bpdias -append'];
        eval(tt);
    elseif savematfile && ~invivo
        tt=['save vitals' subjectid '_' patdate ext ' bpsys bpdias map time_bpsys time_bpdias time_map -append'];
        eval(tt);
    end
end
clear fnametmp
