function config = tMCimg_read_inp(mc_sess)
...
% DATE:   06/24/2009
    ...
    config = struct('phot_num',0, 'seed',0, 'srcpos',[0 0 0], 'srcdirection',[0 0 0], ...
                    'temporal_gates',[0 0 0], 'seg_file','', 'Dx',0, 'Dy',0, 'Dz',0, ...
