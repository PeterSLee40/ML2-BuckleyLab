close all
clear all
addpath('Y:\buckley-lab\Projects\2layer\functions');
...
%for temp_idx = 1:11;
    ...
    for II = 1:5
        ...
        %Load DCS data 
        for i=1:maxfiles
            if exist([fdir 'glycerol_' id '_' num2str(II) '_flow_' num2str(i-1) '.dat'])~=0
                data=load([fdir 'glycerol_' id '_' num2str(II) '_flow_' num2str(i-1) '.dat']);
