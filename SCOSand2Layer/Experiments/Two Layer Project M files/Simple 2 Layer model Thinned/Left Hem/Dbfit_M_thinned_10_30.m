...
load net1_10_30_30khz.mat
load net1_10_30_100khz.mat
...
for differentDb = differentDbs
    ...
    g2slinearized = g2s(:);
    db2net1prediction30(j) = net1(g2slinearized);
    db2net1prediction100(j) = net100(g2slinearized);
end
...
title('10-30cm Neural Net Fits to MC data')
axis equal
axis([1 15 1 15])
%19.5709
