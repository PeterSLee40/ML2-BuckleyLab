...
prepinputshuffle =  normalize(inputshuffle, 2);
pcacoeff = pca(prepinputshuffle);
ppinputshuffle = prepinputshuffle*pcacoeff(:,1:50);
...
for a = 1:5
    for b = 2:5
        ...
        data = data(:)';
        testSet(j, :) = normalize(data, 2) * pcacoeff(:,1:50);
    end
end
...
for retrainingIteration = 1:10
    ...
    [net3, tr] = train(net, (ppinputshuffle)', targetshuffledb2',{}, {}, 100./(targetshuffledb2'), 'useGPU', 'yes');
