...
used_ch = (SD_dist - 10)/5 + 5;%Only looking at DCS data from detector 1
...
%for temp_idx = 1:11;
    ...
    for II = 1:1
        ...
        %Load DCS data 
        for i=1:maxfiles
            if exist([fdir 'TwoLayerBox_noglycerolphantom_200_flow_' num2str(i-1) '.dat'])~=0
                data=load([fdir 'TwoLayerBox_noglycerolphantom_200_flow_' num2str(i-1) '.dat']);
