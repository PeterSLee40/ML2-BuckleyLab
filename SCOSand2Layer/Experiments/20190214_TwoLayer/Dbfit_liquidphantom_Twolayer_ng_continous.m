%function [meanDbfit, meanbetafit, meanbetastdfit] = Dbfit_liquidphantom_Twolayer_continous(SD_dist, id1, id2, plotfits)
SD_dist = 25
id1 = 'TwoLayerBox_noglycerolphantom';
id2 = '200';
plotfits = 'false';
%ext='';
...
Rho = [10, 15, 20, 25];
used_ch = find(Rho == SD_dist) + 4%Only looking at DCS data from detector 2
