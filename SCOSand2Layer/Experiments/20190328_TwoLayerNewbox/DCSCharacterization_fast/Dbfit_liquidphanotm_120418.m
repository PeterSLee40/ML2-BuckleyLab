...
% SD distance
SD_dist = 10;%mm 
used_ch = 3;%Only looking at DCS data from detector 2
...
%for temp_idx = 1:11;
    ...
    for II = 1:5
        ...
        %Load DCS data 
        for i=1:maxfiles
            if exist([fdir 'fast_10mm_' num2str(II) '_flow_' num2str(i-1) '.dat'])~=0
                data=load([fdir 'fast_10mm_' num2str(II) '_flow_' num2str(i-1) '.dat']);
