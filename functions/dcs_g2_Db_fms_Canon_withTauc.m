function result = dcs_g2_Db_fms_Canon_withTauc(s,tau,g2,p,mu_a,mu_sp,alpha)
...
msd = 6*Db * (tau - tauc * (1 - exp(-tau./tauc) ) );
...
fit_g2 = 1 + repmat(beta,1,size(tau,2)) .* ((g1 ./ repmat(g1_1,1,size(tau,2))).^2);
