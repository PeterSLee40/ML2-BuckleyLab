function result = dcs_g2_Db_fms_weighted(s,tau,g2,p,mu_a,mu_sp,alpha,sigma)
...
k0 = 2*pi*1.37/(785*1e-6); 
kd = (3*mu_sp*mu_a + mu_sp^2*k0^2*alpha.*(6*Db * tau + V.^2 * tau.^2)).^(1/2);
