function [alpha,f_alpha,fPrime_alpha,grad,exitflag,funcCount] = ...
            ...
            fminimum,maxFunEvals,TolFunLnSrch,DiffMinChange,DiffMaxChange, ...
            TypicalX,varargin)
...
%           initialStepLength,rho,sigma,fminimum,maxFunEvals,TolFunLnSrch,DiffMinChange, ...
...
%   $Revision: 1.1.6.4 $  $Date: 2007/06/14 05:19:08 $
...
if exitflagBrckt == 2 
  ...
  % within bracket
    [alpha,f_alpha,fPrime_alpha,grad,exitflag,funcCount] = sectioningPhase(funfcn, ...
       ...
       fPrime_a,f_b,fPrime_b,rho,sigma,maxFunEvals,funcCountBrckt,TolFunLnSrch,DiffMinChange, ...
       DiffMaxChange,TypicalX,varargin{:}); 
else              
...
function [alpha,f_alpha,fPrime_alpha,grad,exitflag,funcCount] = ...
  ...
  sigma,maxFunEvals,funcCountBracketingPhase,TolFunLnSrch,DiffMinChange, ...
  DiffMaxChange,TypicalX,varargin) 
%
