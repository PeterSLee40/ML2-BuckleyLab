function CNSvitals_update(subjectid,patdate,exten,savefigures,timeaxis,Markstime,timesyncmark_dcs,savematfile,rotatelabel,invivo,hrmin,bpmin,bpmax,spo2min,rapmin,mapnans)
